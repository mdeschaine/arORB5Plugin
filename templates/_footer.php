<footer class="foot">
    <div class="container">
        ...
        <div class="row row-cols-3 gy-4">
            ...
            <div class="foot-resources col-md-3">
            ...
            <div class="foot-newsletter col-md-6">
        ...
        <div class="row row-cols-2 gy-4">
            <div class="foot-support col-md-6">
        ...
        <div class="row foot-footer gy-4">
